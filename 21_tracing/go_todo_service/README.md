...
Учебный Go-сервис для управления TODO-задач. Он демонстрирует REST, gRPC, PostgreSQL, структурированные логи и распределённую трассировку через OpenTelemetry Collector и Jaeger.
...
Трассировка проходит через весь стек:
...
- **Hot Reload**: [Air](https://github.com/air-verse/air) (для разработки)
...
# Создание задачи
grpcurl -plaintext -H 'user-id: 1' -d '{
  "title": "Купить продукты",
  "description": "Молоко, хлеб, яйца",
  "done": false
